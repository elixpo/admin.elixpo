...
export default async function SettingsPage() {
    ...
    return (
        <Box>
            <PageHeader
                title="Settings"
                subtitle="Token scopes & discovery health"
            />
            ...
            >
                <Panel title="Account">
                    ...
                    <Row
                        label="Discovery cached at"
                        value={new Date(inv.fetchedAt).toLocaleString()}
                    />
                </Panel>
                ...
                <Panel title="Discovery / token scope health">
                    ...
                    >
                        A failing section usually means the CF_API_TOKEN is
                        missing that scope, or the product isn't enabled on the
                        account.
                    </Typography>
